...
export default function HomeRow() {
    ...
    function generateLessonPatterns() {
        ...
        for (let i = 0; i < homeRowKeys.length; i += 2) {
            if (i + 1 < homeRowKeys.length) {
        ...
        for (let i = 0; i < homeRowKeys.length / 2; i++) {
            const leftKey = homeRowKeys[i];
            const rightKey = homeRowKeys[i + 4]; // cross-hand
            let line = [];
        ...
        const mixed = homeRowKeys.concat(homeRowKeys); // to wrap around
        for (let i = 0; i < homeRowKeys.length; i++) {
