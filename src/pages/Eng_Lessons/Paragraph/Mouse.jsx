...
export default function Mouse() {
    ...
    function generateStoryLines() {
        const story = `
    A mouse is a common input device used with computers to control the pointer or cursor on the screen. It allows users to select, drag, and open files or programs easily. A mouse typically has two or more buttons and a scroll wheel for navigation. It can be wired or wireless. The mouse converts physical movement into signals that the computer can understand, making interaction with graphical interfaces simple and efficient. It is widely used in tasks like browsing, gaming, designing, and general computer operation. Without a mouse, navigation would be slower and less precise.
    `;
