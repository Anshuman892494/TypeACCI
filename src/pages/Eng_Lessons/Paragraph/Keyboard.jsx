...
export default function Keyboard() {
    ...
    function generateStoryLines() {
        const story = `
   A keyboard is one of the most common input devices used with computers. It is designed to enter data and commands into a computer by pressing keys. Keyboards have different types of keys, including alphabet keys, number keys, function keys (F1–F12), control keys like Ctrl, Alt, and Shift, and special keys such as Enter, Backspace, and Esc. These keys allow users to perform various operations, such as typing text, executing commands, and navigating on the computer.

Keyboards can be wired or wireless, and some modern keyboards have additional features like backlighting, multimedia keys, and touchpads. They are essential for tasks like document writing, coding, gaming, and data entry. Without a keyboard, entering text and instructions would be slow and difficult, making it a vital device for communication between the user and the computer. The keyboard is simple yet indispensable in computer operations.
    `;
