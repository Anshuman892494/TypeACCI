...
export default function TopRow() {
    ...
    function generateLessonPatterns() {
        const practiceTexts = [];
        const letters = ["q", "w", "e", "r", "u", "i", "o", "p"];

        // 🔹 3-letter words
        const words3 = [
            "qwe", "wer", "rei", "iup", "poi", "rew", "uip", "eqr",
            "wip", "eir", "oqp", "riu", "wqe", "per", "owi", "iqp",
            "uor", "prq", "ewi", "oqr"
        ];

        // 🔹 4-letter words
        const words4 = [
            "qwer", "weio", "reup", "ioup", "qrei", "ewip", "poir",
            "uirp", "qpoi", "wepr", "ieur", "rwqp", "eiou", "urpw",
            "qewr", "wqer", "iore", "pwui", "uqer", "eipr"
        ];

        // 🔹 5-letter words
        const words5 = [
            "qweir", "weiup", "reiop", "iupor", "qwepo", "rewip",
            "poiur", "uipwe", "qreio", "ewrip", "poirw", "uirpe",
            "qwepr", "weqri", "iopur", "pweir", "uqeri", "eipor",
            "rewqi", "pouri"
        ];
