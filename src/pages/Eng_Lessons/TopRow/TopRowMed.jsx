...
export default function TopRow() {
    ...
    function generateLessonPatterns() {
        ...
        for (let i = 0; i < topRowKeys.length - 2; i++) {
            practiceTexts.push(
                `${topRowKeys[i]}${topRowKeys[i + 1]} ` +
                `${topRowKeys[i + 1]}${topRowKeys[i + 2]} ` +
                `${topRowKeys[i]}${topRowKeys[i + 1]}${topRowKeys[i + 2]}`
            );
        }
        ...
        for (let i = 0; i < 4; i++) {
            practiceTexts.push(
                `${topRowKeys[i]}${topRowKeys[i + 1]} ` +
                `${topRowKeys[i + 4]}${topRowKeys[i + 5]} ` +
                `${topRowKeys[i]}${topRowKeys[i + 4]}${topRowKeys[i + 5]}`
            );
        }
