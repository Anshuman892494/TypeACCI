...
export default function HomeRow() {
    ...
    function generateLessonPatterns() {
        ...
        // 🔹 3-letter words
        const words3 = [
            "zxc", "vbn", "mxc", "bvn", "nvc", "czv", "xvb", "bzm",
            "vnc", "mxv", "zvm", "bcn", "vbm", "nxb", "czm", "mnb",
            "xnv", "vcn", "bmx", "nzv", "czb"
        ];

        // 🔹 4-letter words
        const words4 = [
            "vbnm", "xczv", "znvb", "mnbv", "cvbn", "xbnm", "zncm",
            "vbxn", "mcvb", "bnzx", "xvbn", "nmbv", "czxn", "vbmx",
            "nzvc", "bmxn", "vcnm", "zbnx", "mxvb", "cvbn"
        ];

        // 🔹 5-letter words
        const words5 = [
            "vbnmx", "xczvb", "znvbm", "mnbvc", "cvbnm", "xbnvm",
            "zncmb", "vbxnm", "mcvbn", "bnzxc", "xvbnm", "nmbvc",
            "czxvn", "vbmxn", "nzvbc", "bmxnv", "vcnmb", "zbnxm",
            "mxvbn", "cvbnx"
        ];
