...
export default function BottomRow() {
    ...
    function generateLessonPatterns() {
        ...
        for (let i = 0; i < bottomRowKeys.length; i += 2) {
            if (i + 1 < bottomRowKeys.length) {
        ...
        for (let i = 0; i < bottomRowKeys.length / 2; i++) {
            const leftKey = bottomRowKeys[i];
            const rightKey = bottomRowKeys[i + 4]; // cross-hand
            let line = [];
        ...
        const mixed = bottomRowKeys.concat(bottomRowKeys); // to wrap around
